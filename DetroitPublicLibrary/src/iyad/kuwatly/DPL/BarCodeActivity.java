...
public class BarCodeActivity extends Activity implements OnClickListener {
	...
	private Button scanBtn, previewBtn, linkBtn,holdBtn;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		holdBtn = (Button)this.findViewById(R.id.hold_btn);
		holdBtn.setVisibility(View.GONE);
		//holdBtn.setOnClickListener(this);
		
		//preview and link buttons
		previewBtn = (Button)this.findViewById(R.id.preview_btn);
		previewBtn.setVisibility(View.GONE);
		previewBtn.setOnClickListener(this);
		linkBtn = (Button)this.findViewById(R.id.link_btn);
		linkBtn.setVisibility(View.GONE);
		linkBtn.setOnClickListener(this);

		//ui items
		authorText = (TextView)this.findViewById(R.id.book_author);
		titleText = (TextView)this.findViewById(R.id.book_title);
		descriptionText = (TextView)this.findViewById(R.id.book_description);
		dateText = (TextView)this.findViewById(R.id.book_date);
		starLayout = (LinearLayout)this.findViewById(R.id.star_layout);
		ratingCountText = (TextView)this.findViewById(R.id.book_rating_count);
	...
	public void onClick(View v){
		...
		if(v.getId()==R.id.scan_button){
			...
			Intent intent = new Intent(this, EmbeddedBookActivity.class);
		...
		if (scanningResult != null) {
			...
			if(scanContent!=null && scanFormat!=null && scanFormat.equalsIgnoreCase("EAN_13")){
				...
				String bookSearchString = "https://www.googleapis.com/books/v1/volumes?" +
						"q=isbn:"+scanContent+"&key=AIzaSyDpQ4q8WcRhWA1CZxSfVic6d8UP2qihhbw";
